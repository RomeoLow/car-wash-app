...
export default function AdminScreen({ navigation }: any) {
  ...
  // Define management feature menu for easy expansion
  const menuItems = [
    { id: 'revenue', label: 'Daily Revenue', icon: '💰', screen: 'RevenueReports' },
    { id: 'staff', label: 'Manage Staff', icon: '👥', screen: 'StaffManagement' },
    { id: 'reports', label: 'Reports', icon: '📊', screen: 'RevenueReports' }, // also can jump to the same or different reports.
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView style={styles.container}>
        ...
        {/* Statistics Overview Area (to make the page look more professional) */}
